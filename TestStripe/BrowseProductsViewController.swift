...
class BrowseProductsViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let titleAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): theme.primaryForegroundColor, NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): theme.font]
        let buttonAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): theme.accentColor, NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): theme.font]
